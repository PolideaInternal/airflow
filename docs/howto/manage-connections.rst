...
Cloudsql
~~~~~~~~
The cloudsql:// connection is used by
...
Extra (optional)
    ...
    .. code-block:: bash
        ...
        cloudsql://user:XXXXXXXXX@1.1.1.1:3306/mydb?database_type=mysql&project_id=example-project&location=europe-west1&instance=testinstance&use_proxy=True&sql_proxy_use_tcp=False
