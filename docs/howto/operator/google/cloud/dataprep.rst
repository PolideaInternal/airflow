...
=======================================
`Google Dataprep API documentation is availble here <https://cloud.google.com/dataprep/docs/html/API-Reference_145281441>`__
...
To get information about the batch jobs within a Cloud Dataprep job use:
