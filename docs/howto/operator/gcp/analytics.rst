...
.. _howto/operator:GoogleAnalyticsGetAdsLinksOperator:

Get Ads Links
^^^^^^^^^^^^^

To list accounts from Analytics you can use the
:class:`~airflow.providers.google.marketing_platform.operators.analytics.GoogleAnalyticsGetAdsLinksOperator`.

.. exampleinclude:: ../../../../airflow/providers/google/marketing_platform/example_dags/example_analytics.py
    :language: python
    :dedent: 4
    :start-after: [START howto_marketing_platform_get_ads_links_operator]
    :end-before: [END howto_marketing_platform_list_get_ads_links_operator]

You can use :ref:`Jinja templating <jinja-templating>` with
:template-fields:`airflow.providers.google.marketing_platform.operators.analytics.GoogleAnalyticsGetAdsLinksOperator`
