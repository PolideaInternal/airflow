...
#
#     def __init__(self):
#         # self.google_host = _get_config_param('host')
...
#             'google',
#             consumer_key=_get_config_param('client_id'),
#             consumer_secret=_get_config_param('client_secret'),
...
#
#         self.flask_app.add_url_rule(_get_config_param('oauth_callback_route'),
...
#         domains = _get_config_param('domain').split(',')
...
#
#
# def login(self, request):  # pylint:disable=unused-argument,redefined-outer-name
