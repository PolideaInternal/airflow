...
class CloudSqlQueryOperator(BaseOperator):
    ...
    :param database: name of database which overwrites the name defined in the connection
    :type database: str
    ...
    def __init__(self,
        ...
        self.cloudsql_db_hook = CloudSqlDatabaseHook(cloudsql_conn_id=cloudsql_conn_id)
