...
class GoogleCampaignManagerBatchInsertConversationOperator(BaseOperator):
    """
    Inserts conversions.
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:GoogleCampaignManagerBatchInsertConversationOperator`
...
class GoogleCampaignManagerBatchUpdateConversationOperator(BaseOperator):
    """
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:GoogleCampaignManagerBatchUpdateConversationOperator`
