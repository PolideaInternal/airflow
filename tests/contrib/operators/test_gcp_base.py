...
class BaseGcpIntegrationTestCase(unittest.TestCase):
    ...
    def _gcp_authenticate(self):
        ...
        full_key_path = os.path.join(key_dir_path, self.gcp_key)
        ...
        print("Setting the GCP key to {}".format(full_key_path))
        ...
        # that all works fine with the credentials retrieved from te
