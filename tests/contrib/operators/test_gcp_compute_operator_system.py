...
@unittest.skipIf(
    BaseGcpSystemTestCase.skip_check(GCP_COMPUTE_KEY), SKIP_TEST_WARNING)
class GcpComputeExampleDagsSystemTest(BaseGcpSystemTestCase):
...
@unittest.skipIf(
    BaseGcpSystemTestCase.skip_check(GCP_COMPUTE_KEY), SKIP_TEST_WARNING)
class GcpComputeIgmExampleDagsSystemTest(BaseGcpSystemTestCase):
