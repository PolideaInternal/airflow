...
from tests.contrib.operators.test_gcp_base_system_test import BaseGcpSystemTestCase, \
    GCP_CLOUDSQL_KEY, SKIP_TEST_WARNING
from tests.contrib.operators.test_gcp_sql_operator_helper import \
...
@unittest.skipIf(BaseGcpSystemTestCase.skip_check(GCP_CLOUDSQL_KEY), SKIP_TEST_WARNING)
class CloudSqlExampleDagsIntegrationTest(BaseGcpSystemTestCase):
    ...
    def test_run_example_dag_cloudsql(self):
        try:
            ...
            self.log.warning(
                ...
                "can remove '.random' file from incubator-airflow folder and re-run "
