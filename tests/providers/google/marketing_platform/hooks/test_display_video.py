...
class TestGoogleDisplayVideo360Hook(TestCase):
    ...
    #     "display_video.GoogleDisplayVideo360Hook.get_conn_to_display_video"
    # )
    # def test_get_operation_called_once(self, get_conn_to_display_video):
    #
    #     operation_name = get_conn_to_display_video.return_value.get_sdf_download_operation()
    #     self.hook.get_operation(operation_name=operation_name)
    #
    #     get_conn_to_display_video.return_value.\
    ...
    #     "display_video.GoogleDisplayVideo360Hook.get_conn_to_display_video"
    # )
    # def test_get_operation_called_once_with_params(self, get_conn_to_display_video):
    #
    #     operation_name = get_conn_to_display_video.return_value.get_sdf_download_operation()
    #     self.hook.get_operation(operation_name=operation_name)
    #     name = get_conn_to_display_video.return_value.get_sdf_download_operation.return_value.get()
    #
    #     get_conn_to_display_video.return_value. \
    #         projects.return_value. \
    #         locations.return_value. \
