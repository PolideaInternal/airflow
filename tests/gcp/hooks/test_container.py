...
from airflow.gcp.hooks.container import GKEClusterHook
...
class GKEClusterHookDeleteTest(unittest.TestCase):
    ...
    @mock.patch("airflow.gcp.hooks.container.GKEClusterHook._dict_to_proto")
    @mock.patch(
        "airflow.gcp.hooks.container.GKEClusterHook.wait_for_operation")
    ...
    @mock.patch(
        "airflow.gcp.hooks.container.GKEClusterHook.log")
    @mock.patch("airflow.gcp.hooks.container.GKEClusterHook._dict_to_proto")
    @mock.patch(
        "airflow.gcp.hooks.container.GKEClusterHook.wait_for_operation")
...
class GKEClusterHookTest(unittest.TestCase):
    ...
    @mock.patch('airflow.gcp.hooks.container.container_v1.'
                'ClusterManagerClient')
    @mock.patch('airflow.contrib.hooks.gcp_api_base_hook.ClientInfo')
    @mock.patch('airflow.gcp.hooks.container.GKEClusterHook._get_credentials')
    ...
    @mock.patch("airflow.gcp.hooks.container.GKEClusterHook.get_operation")
    @mock.patch("time.sleep")
