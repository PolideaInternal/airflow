...
from airflow.gcp.operators.container import GKEClusterCreateOperator, \
...
class GoogleCloudPlatformContainerOperatorTest(unittest.TestCase):
    ...
    @mock.patch('airflow.gcp.operators.container.GKEClusterHook')
...
class GKEPodOperatorTest(unittest.TestCase):
    ...
    @mock.patch('airflow.gcp.operators.container.GKEPodOperator.log')
